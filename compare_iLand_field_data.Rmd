...
df_origin_values_sankey <- fread('outTable/df_origin_values_sankey.csv')
...
```{r silhouette, echo = F, fig.width=3.4, fig.height = 5}
...
I selected only single scenario here for visualization.
